...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --build=i686-pc-mingw32 --prefix=d:/usr --with-auto-load-dir='$$debugdir;$$datadir/../auto-load' --with-auto-load-safe-path='$$debugdir;$$datadir/../auto-load' --with-gdb-datadir=d:/usr/share/gdb/13.1 --with-python=d:/usr/Python344 --with-system-gdbinit=d:/usr/etc/gdbinit --enable-tui --with-system-zlib --enable-unit-tests --with-pkgversion='MinGW32 GDB' --disable-shared

tooldir = ${exec_prefix}/i686-pc-mingw32
build_tooldir = ${exec_prefix}/i686-pc-mingw32
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=d:/usr' '--with-auto-load-dir=$$debugdir;$$datadir/../auto-load' '--with-auto-load-safe-path=$$debugdir;$$datadir/../auto-load' '--with-gdb-datadir=d:/usr/share/gdb/13.1' '--with-python=d:/usr/Python344' '--with-system-gdbinit=d:/usr/etc/gdbinit' '--enable-tui' '--with-system-zlib' '--enable-unit-tests' '--with-pkgversion=MinGW32 GDB' '--disable-shared' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd readline libbacktrace libdecnumber libctf libsframe sim gdb gdbserver etc gnulib gdbsupport
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-system-zlib '--prefix=d:/usr' '--with-auto-load-dir=$$debugdir;$$datadir/../auto-load' '--with-auto-load-safe-path=$$debugdir;$$datadir/../auto-load' '--with-gdb-datadir=d:/usr/share/gdb/13.1' '--with-python=d:/usr/Python344' '--with-system-gdbinit=d:/usr/etc/gdbinit' '--enable-tui' '--with-system-zlib' '--enable-unit-tests' '--with-pkgversion=MinGW32 GDB' '--disable-shared' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--prefix=d:/usr' '--with-auto-load-dir=$debugdir;$datadir/../auto-load' '--with-auto-load-safe-path=$debugdir;$datadir/../auto-load' '--with-gdb-datadir=d:/usr/share/gdb/13.1' '--with-python=d:/usr/Python344' '--with-system-gdbinit=d:/usr/etc/gdbinit' '--enable-tui' '--with-system-zlib' '--enable-unit-tests' '--with-pkgversion=MinGW32 GDB' '--disable-shared' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
CPP_FOR_BUILD = 
CPPFLAGS_FOR_BUILD = 
CXXFLAGS_FOR_BUILD = -O2 -gdwarf-4 -g3
CXX_FOR_BUILD = $(CXX)
...
AS = as
AR = ar --plugin d:/usr/bin/../libexec/gcc/mingw32/9.2.0/liblto_plugin-0.dll
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = dlltool
DSYMUTIL = dsymutil
LD = d:/usr/bin/../lib/gcc/mingw32/9.2.0/../../../../mingw32/bin/ld.exe
LIPO = lipo
NM = nm
OBJDUMP = objdump
OTOOL = otool
RANLIB = ranlib --plugin d:/usr/bin/../libexec/gcc/mingw32/9.2.0/liblto_plugin-0.dll
READELF = readelf
STRIP = strip
WINDRES = windres
WINDMC = windmc
...
CFLAGS_FOR_TARGET = -O2 -gdwarf-4 -g3
CXXFLAGS_FOR_TARGET = -O2 -gdwarf-4 -g3
